...
public class VolcanoGenerator extends StructureGenerator {
    ...
    public VolcanoGenerator(
            BlockMetaPair fluid,
            BlockMetaPair mountainMaterial,
            BlockMetaPair shaftMaterial,
            int maxDepth,
            boolean magmaChamber) {
        this.fluid = fluid;
    ...
    protected boolean canGenerateHere(int chunkX, int chunkZ, Random rand) {
        ...
        // this square of chunk coords superchunkX,superchunkX+range-1 and
        // superchunkZ,superchunkZ+range-1
