...
public class ARVillageComponentHouse extends ARVillageComponent {
    ...
    public ARVillageComponentHouse(ARVillageComponentStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static ARVillageComponentHouse func_74921_a(ARVillageComponentStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        final StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 17, 9, 17, par6);
        return StructureComponent.findIntersecting(par1List, var8) == null ? new ARVillageComponentHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6) : null;
    }
        ...
        for (int i = 5; i <= 11; i++)
        {
            for (int j = 5; j <= 11; j++)
            {
                if (!(j == 5 && i == 5 || j == 5 && i == 11 || j == 11 && i == 5 || j == 11 && i == 11))
                {
                    ...
                    {
                        this.placeBlockAtCurrentPosition(par1World, GCBlocks.basicBlock, 4, i, yLevel, j, par3StructureBoundingBox);
                    }
                }
            }
        }
