...
public class ARVillageComponentWell extends ARVillageComponent
{
    private int averageGroundLevel = -1;

    public ARVillageComponentWell()
    {
    }
    ...
    {
        ARVillagePieces.getNextStructureComponentVillagePath((ARVillageComponentStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 1, this.getComponentType());
        ARVillagePieces.getNextStructureComponentVillagePath((ARVillageComponentStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 3, this.getComponentType());
        ARVillagePieces.getNextStructureComponentVillagePath((ARVillageComponentStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, 2, this.getComponentType());
        ARVillagePieces.getNextStructureComponentVillagePath((ARVillageComponentStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
    }
