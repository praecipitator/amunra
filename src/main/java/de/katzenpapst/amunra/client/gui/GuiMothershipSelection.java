...
public class GuiMothershipSelection extends GuiARCelestialSelection {
    ...
    public void initGui() {
        ...
        //if(!curMothership.isInTransit()) {
            AmunRa.packetPipeline.sendToServer(new PacketSimpleAR(PacketSimpleAR.EnumSimplePacket.S_MOTHERSHIP_UPDATE, world.provider.getDimensionId()));
        //}
    }
    ...
    protected void drawTransitBar(int length)
    {
        ...
        this.drawTexturedModalRect(
                width/2-90+27,
                height-11-GuiCelestialSelection.BORDER_SIZE+2,
                1, //displayed w
                4,  //displayed h
                0,    // u aka x in tex
                0,      // v
    ...
    protected void drawTransitInfo(int mousePosX, int mousePosY)
    {
        ...
        this.drawTexturedModalRect(
                width/2-90,
                height-11-GuiCelestialSelection.BORDER_SIZE-4,
                TRANSIT_INFO_W, //w
                TRANSIT_INFO_H,  //h
                TRANSIT_INFO_U,    // u
                TRANSIT_INFO_V,      // v
     ...
     // bar
        ...
        /*this.drawTexturedModalRect(
                ...
                4,      // h in texture
                false, false);*/
        if(isMouseWithin(mousePosX, mousePosY, width/2-90+28, height-11-GuiCelestialSelection.BORDER_SIZE+2, 124, 4)) {
        ...
        int bodyY = height-11-GuiCelestialSelection.BORDER_SIZE;
        ...
        bodyY = height-11-GuiCelestialSelection.BORDER_SIZE;
    ...
    protected void drawMothershipGuiParts(int mousePosX, int mousePosY)
    {
        ...
        offsetX = width - GuiCelestialSelection.BORDER_SIZE - GuiCelestialSelection.BORDER_EDGE_SIZE;
        offsetY = GuiCelestialSelection.BORDER_SIZE + GuiCelestialSelection.BORDER_EDGE_SIZE;
    ...
    protected final int RENAMEBUTTON_H = 12;*/
        ...
        this.fontRendererObj.drawString(GCCoreUtil.translate("gui.message.mothership.totalMass")+": "+GuiHelper.formatKilogram(totalMass),
                offsetX - 90,
                bottomOffset-totalOffset,
        ...
        this.fontRendererObj.drawString(GCCoreUtil.translate("gui.message.mothership.totalBlocks")+": "+GuiHelper.formatMetric(provider.getNumBlocks()),
                offsetX - 90,
                bottomOffset-totalOffset,
                ColorUtil.to32BitColor(255, 255, 255, 255),
                false);
        ...
        this.fontRendererObj.drawString(GCCoreUtil.translate("gui.message.mothership.travelThrust")+": "+GuiHelper.formatMetric(tData.thrust, "N"),
                offsetX - 90,
                bottomOffset-totalOffset,
                thrustColor,
                false);
        ...
        if(curMothership.isInTransit()) {
            ...
            this.fontRendererObj.drawString(GCCoreUtil.translate("gui.message.mothership.travelSpeed")+": "+GuiHelper.formatSpeed(speed),
                    offsetX - 90,
                    bottomOffset-totalOffset,
                    thrustColor,
                    false);
    ...
    protected void drawTargetBodyInfo(int mousePosX, int mousePosY) {
        ...
        case ALREADY_ORBITING:
            this.fontRendererObj.drawSplitString(GCCoreUtil.translate("gui.message.mothership.alreadyOrbiting"),
                    offsetX - 90,
        ...
        case NOT_ENOUGH_FUEL:
            ...
            offset = drawTravelTime(offset, travelDistance, travelTime);
            offset = drawFuelReqs(offset, mousePosX, mousePosY, tData.fuelReqData);
            this.fontRendererObj.drawSplitString(GCCoreUtil.translate("gui.message.mothership.notEnoughFuel"),
                    offsetX - 90,
        ...
        case NOT_ENOUGH_THRUST:
            ...
            offset = drawTravelTime(offset, travelDistance, travelTime);
            offset = drawFuelReqs(offset, mousePosX, mousePosY, tData.fuelReqData);
            this.fontRendererObj.drawSplitString(GCCoreUtil.translate("gui.message.mothership.notEnoughThrust"),
                    offsetX - 90,
                    offsetY + offset, 90, ColorUtil.to32BitColor(255, 255, 128, 128));
            offset += 10;
            break;
        case NOT_ORBITABLE:
            this.fontRendererObj.drawSplitString(GCCoreUtil.translate("gui.message.mothership.unreachableBody"),
                    offsetX - 90,
                    offsetY + offset, 90, ColorUtil.to32BitColor(255, 255, 128, 128));
            offset += 10;
            break;
        case TRAVEL_TOO_LONG:
            ...
            offset = drawTravelTime(offset, travelDistance, travelTime);
            offset = drawFuelReqs(offset, mousePosX, mousePosY, tData.fuelReqData);
            this.fontRendererObj.drawSplitString(GCCoreUtil.translate("gui.message.mothership.travelTooLong"),
                    offsetX - 90,
                    offsetY + offset, 90, ColorUtil.to32BitColor(255, 255, 128, 128));
            offset += 10;
    ...
    protected int drawFuelReqs(int offset, int mousePosX, int mousePosY, MothershipFuelRequirements fuelReqs) {
        ...
        if(fuelReqs != null && !fuelReqs.isEmpty()) {
            //offset += 10;
            this.fontRendererObj.drawSplitString(GCCoreUtil.translate("gui.message.mothership.fuelReqs") + ":",
                    offsetX - 90,
                    offsetY + offset, 90, ColorUtil.to32BitColor(255, 255, 255, 255));
            for(MothershipFuelDisplay f: fuelReqs.getData().keySet()) {
                ...
                this.fontRendererObj.drawSplitString(f.formatValue(fuelReqs.getData().get(f)),
                        offsetX - 80,
                        offsetY + offset, 90, ColorUtil.to32BitColor(255, 255, 255, 255));
            }
            offset += 10;
    ...
    protected int drawTravelDistance(int offset, double travelDistance) {
     // travel distance
        this.fontRendererObj.drawString(GCCoreUtil.translate("gui.message.mothership.travelDistance")+": "+
    ...
    protected int drawTravelTime(int offset, double travelDistance, long travelTime) {
        ...
        // travel time
        this.fontRendererObj.drawString(GCCoreUtil.translate("gui.message.mothership.travelTime")+": "+travelTimeStr,
                offsetX - 90,
                offsetY + offset,
                ColorUtil.to32BitColor(255, 255, 255, 255),
                false);
